...
return [
    ...
    [
        ...
        'name' => 'Wompi',
        'info' => 'Pasarela de pagos Wompi Colombia (tarjeta, Nequi, PSE, Bancolombia)',
        'sort' => 0,
        'fields' => [
            [
                'name' => 'active',
                ...
                'channel_based' => true,
                'locale_based' => false,
                'info' => 'prv_test_... o prv_prod_...',
            ], [
                'name' => 'integrity_key',
                'title' => 'Llave de Integridad',
                'type' => 'password',
                'depends' => 'active:1',
                'channel_based' => true,
                'locale_based' => false,
                'info' => 'test_integrity_... o prod_integrity_...',
            ], [
                'name' => 'events_key',
                'title' => 'Llave de Eventos',
                'type' => 'password',
                'depends' => 'active:1',
                'channel_based' => true,
                'locale_based' => false,
                'info' => 'test_events_... o prod_events_... (para webhooks)',
            ], [
                'name' => 'sandbox',
                'title' => 'admin::app.configuration.index.sales.payment-methods.sandbox',
                'type' => 'boolean',
